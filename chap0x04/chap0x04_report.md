...
#-help脚本内置帮助信息
    ...
    -r R               对jpeg/png/svg格式图片在保持原始宽高比的前提下压缩成D分辨率
...
```
- 测试结果 
![任务一测试结果](img/task1_processing.png)
### 任务二
...
```
- 测试结果 
![任务二测试结果](/img/task2_processing.png)
###### ☑统计不同年龄区间范围（20岁以下、[20-30]、30岁以上）的球员数量、百分比
```
...
```
- 测试结果
![任务三测试结果](/img/task3-1.png)
![任务三测试结果](/img/task3-2.png)
![任务三测试结果](/img/task3-3.png)
###### ☑统计访问来源主机TOP 100和分别对应出现的总次数
...
###### ☑给定URL输出TOP 100访问来源主机
###### 测试时选择的URL为 ```/software/winvn/winvn.html/wvsmall.gif```
```
                             TOP100_host        count
                         user36.znet.com        7
...
- [LyuLumos的文档](https://github.com/CUCCS/linux-2020-LyuLumos/blob/ch0x04/ch0x04/code/)
